...
var Histogram = stats.Histogram = function Histogram(params) {
    ...
    this.percentilePrefix = params && params.percentilePrefix || '';
    this.percentileSuffix = params && params.percentileSuffix || '%';
    this.clear();
};
Histogram.prototype =  {
    clear: function() {
    ...
    summary: function() {
        ...
        self.percentiles.forEach(function(percentile) {
            s[self.percentilePrefix + percentile * 100 + self.percentileSuffix] = self.percentile(percentile);
        });
        return s;
    },
